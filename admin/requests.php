                        ...
                        <div class="card-block">
                            <table class="table table-bordered table-hover">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `bookings` JOIN users ON bookings.user_id = users.id JOIN staff ON bookings.staff_id = staff.staffID WHERE bookings.staff_id = '$staff_id' ORDER BY bookings.created_at DESC";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-success" title="view location" data-toggle="modal"
                                                   data-target="#detailModal<?php echo $row['book_id']; ?>">
                                                ...
                                                <?php
                                                    if ($row['status'] == 2)   {
                                                        ?>
                                                            ...
                                                            <a href="validations/delivery.php?book_id=<?php echo $row['book_id']; ?>" class="btn btn-danger" title="Cancel Request"> Complete
                                                            </a>
